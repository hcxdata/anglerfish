...
RSpec.describe SearchRequestsController, type: :controller do
  ...
  # SearchRequest. As you add validations to SearchRequest, be sure to
  ...
  # SearchRequestsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET #show" do
    it "assigns the requested search_request as @search_request" do
      search_request = SearchRequest.create! valid_attributes
      get :show, {:id => search_request.to_param}, valid_session
      expect(assigns(:search_request)).to eq(search_request)
    end
  end
  ...
  describe "GET #edit" do
    it "assigns the requested search_request as @search_request" do
      search_request = SearchRequest.create! valid_attributes
      get :edit, {:id => search_request.to_param}, valid_session
      expect(assigns(:search_request)).to eq(search_request)
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested search_request" do
        search_request = SearchRequest.create! valid_attributes
        put :update, {:id => search_request.to_param, :search_request => new_attributes}, valid_session
        search_request.reload
        skip("Add assertions for updated state")
      end

      it "assigns the requested search_request as @search_request" do
        search_request = SearchRequest.create! valid_attributes
        put :update, {:id => search_request.to_param, :search_request => valid_attributes}, valid_session
        expect(assigns(:search_request)).to eq(search_request)
      end

      it "redirects to the search_request" do
        search_request = SearchRequest.create! valid_attributes
        put :update, {:id => search_request.to_param, :search_request => valid_attributes}, valid_session
        expect(response).to redirect_to(search_request)
      end
    end

    context "with invalid params" do
      it "assigns the search_request as @search_request" do
        search_request = SearchRequest.create! valid_attributes
        put :update, {:id => search_request.to_param, :search_request => invalid_attributes}, valid_session
        expect(assigns(:search_request)).to eq(search_request)
      end
